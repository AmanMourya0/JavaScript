...
// let uniqueValue = numbers.filter((currEle,index,arr) => {
...
// const numbers = [1, 2, 3, 4, 6, 5, 6, 7, 8, 9];
// const unique = numbers.filter(val => {
...
// const numbers = [1, 2, 3, 4, 6, 5, 6, 7, 8, 9];
// const sortedN = numbers.sort((a,b) => {
//     return (a>b)?-1:1
// })
// console.log(sortedN);
//* =========================================
...
// const numbers = [1, 2, 3, 4, 6, 5, 6, 7, 8, 9];
// numbers.filter((ce)=>{ce===4})
// console.log(numbers);

// const fruits = ["Banana", "Apple", "Orange", "Mango"];
// const cFruits = fruits.map((curr)=>{return curr.toUpperCase()})
// console.log(cFruits);

// const numbers = [1, 2, 3, 4, 6, 5, 6, 7, 8, 9];
// const evenSquare = numbers.map((curr)=>{return (curr%2==0)?curr*curr:curr})
// console.log(evenSquare);

// const fruits = ["Banana", "Apple", "Orange", "Mango"];
// const mrFruits = fruits.map((curr)=>{
//     return "Mr."+curr
// })
// console.log(mrFruits);
...
// itemsPrice=[200,600]
// const totalPrice = itemsPrice.reduce((acc,curr)=>{
//     return acc+curr
// },0)
